...
The current reference [worker](https://github.com/abinit/abinit_web/blob/main/docs/workers.md) is "eos", with reference builder "eos_gnu_13.2_mpich (EOF)". In order to understand the rationale behind the set of the different builders let's first detail this reference builder LPR.

EOF "eos_gnu_13.2_mpich" is characterized by the following elements :
  *  The compiler is gcc 123.2 with "-O2 -g -Wall -Wno-maybe-uninitialized -ffpe-trap=invalid,zero,overflow -fbacktrace -fcheck=all,no-pointer -fallow-argument-mismatch -lcurl" flags.
...
|--------|----------------|------------------------------|----------|--------------|---------------|--------------------|----------------|---------------------------------------------|
| alps   | 2              | alps_gnu_9.5_sdebug          | yes      | gnu-9.5      | mpich-4.2.3   | OpenBLAS_0.3.10<br>fftw3 | ABPW | -fno-frontend-optimize<br>-ffpe-trap=i,z,o |
|        |                | alps_intel_2024_oneAPI       | no      | intel<br>oneAPI_2024.2 | intel mpi  | mkl 2024.2 | APW | scalapack ifort 2021.13 |
|        |                | alps_intel_2025_oneAPI       | no      | intel<br>oneAPI_2024.2 | intel mpi  | mkl 2024.2 | APW | scalapack ifx  |
...
| eos    | 3              | eos_nvhpc_23.9_elpa          | yes      | nvhpc 23.9   | openmpi-4.1.6 |                    |                | cuda 12                                    |
|        |                | eos_nvhpc_23.11_elpa         | no       | nvhpc 23.11  | openmpi-4.1.6 | netlib             | elpa 2022      |                                             |
|        |                | eos_gnu_13.2_mpich           | yes      | gnu-9.5      | mpich-4.2.3   | OpenBLAS_0.3.10<br>fftw3 | ABPW | -fno-frontend-optimize<br>-ffpe-trap=i,z,o |
|        |                | eos_gnu_13.2_serial          | yes      | gnu-9.5      | mpich-4.2.3   | OpenBLAS_0.3.10<br>fftw3 | ABPW | -fno-frontend-optimize<br>-ffpe-trap=i,z,o |
| higgs  | 1              | higgs_gnu_12.3_cov           | odonly   | gnu-12.3     | mpich-4.1.2   | mkl 2019           | ABPW           | coverage analysis<br>enable-netcdf-default |
